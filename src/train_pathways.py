...
def main(train_idx: List[int], test_idx: List[int], cell_class: str):
    ...
    max_epochs = 10 if cell_class in ["IN_PVALB_CHC", "IN_LAMP5_LHX6", "PC", "SMC", "VMLC", "Immune", "PVM"] else 10
...
if __name__ == "__main__":
    ...
    for _ in range(1):
        ...
        #for cell_class in ["IN", "En do", "Mural", "Micro", "Astro", "EN", "OPC", "Oligo"]:

        for cell_class in [ "IN", "EN"]:
